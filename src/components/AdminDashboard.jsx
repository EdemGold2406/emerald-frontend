...
const AdminDashboard = () => {
  ...
  // ==========================================
  // MOCK DATA (Extracted from Legacy Videos)
  // ==========================================
  ...
  const students =[
    ...
    { id: 4, regNo: "EFA/JS/16/0156", firstName: "CARSON", otherName: "EBHAT", surname: "INOK-KUTIE", email: "cinokkutie7@efa.sch.ng", dob: "11 May, 2015", gender: "M", pass: "hN8bGdOB" },
    { id: 5, regNo: "EFA/JS/18/0232", firstName: "CHERYL", otherName: "VICTOR", surname: "AKPABAN", email: "cakpaban8@efa.sch.ng", dob: "29 January, 2013", gender: "F", pass: "KBhBR5rB" }
  ];
  ...
  const teachers =[
    ...
    { id: 3, name: "ANEKAN", startYear: 2019, email: "maniekan@efs.sedu.ng", pass: "1xfqTxG", level: "Junior High School", status: "Staff", hasClass: false },
    { id: 4, name: "ANETTE PETER", startYear: 2025, email: "apeter@efs.sedu.ng", pass: "KJvN99u", level: "Senior High School", status: "Staff", hasClass: false }
  ];
  ...
  const classesList =[
    ...
    { id: 3, class: "J.S.S 2", desc: "CHINUA ACHEBE A", max: 22, level: "Junior High School" },
    { id: 4, class: "YEAR 1", desc: "ALLAMANDA A", max: 25, level: "Year School" },
    { id: 5, class: "PLAYGROUP", desc: "TULIP A", max: 15, level: "Early Years" }
  ];
  ...
  const subjectsList =[
    ...
    { id: 4, name: "BEAUTY AND COSMETOLOGY", desc: "", school: "Senior High School" },
  ...
  const termsList =[
    ...
    { id: 3, name: "Term III", desc: "", session: "2024/2025", fees: "₦265,000" }
  ];
          ...
          {[
            ...
            <button 
              ...
              className={`w-full text-left px-4 py-3 rounded text-sm font-bold uppercase tracking-wider transition-all duration-200 ${
                activeTab === tab.id 
                  ? 'bg-emeraldGreen text-white shadow-md' 
      ...
      <div className="flex-1 p-4 md:p-8 bg-gray-50 dark:bg-darkBase transition-colors w-full overflow-x-hidden">
        ...
        {activeTab === 'overview' && (
          <div className="animate-fade-in">
            ...
            {/* Quick Actions matching legacy system */}
        ...
        {activeTab === 'students' && (
          <div className="animate-fade-in">
            <h2 className="text-2xl font-display uppercase tracking-wider text-gray-900 dark:text-white mb-4">100 Students Record</h2>
        ...
        {activeTab === 'subjects' && (
          <div className="animate-fade-in">
            <h2 className="text-2xl font-display uppercase tracking-wider text-gray-900 dark:text-white mb-4">Subjects</h2>
            <div className="bg-white dark:bg-darkSurface shadow-sm border border-gray-200 dark:border-darkBorder rounded overflow-hidden">
              <table className="w-full text-left border-collapse">
                <thead><tr className="bg-gray-50 dark:bg-[#111] border-b border-gray-200 dark:border-darkBorder text-gray-500 dark:text-gray-400 text-xs uppercase tracking-widest"><th className="p-4">#</th><th className="p-4">Subject Name</th><th className="p-4">Subject Description</th><th className="p-4">School</th><th className="p-4">Action</th></tr></thead>
                <tbody className="text-gray-800 dark:text-gray-200 text-sm">
        ...
        {activeTab === 'grades' && (
          <div className="animate-fade-in">
            ...
            <div className="bg-white dark:bg-darkSurface shadow-sm border border-gray-200 dark:border-darkBorder rounded overflow-hidden">
              <table className="w-full text-left border-collapse">
                <thead><tr className="bg-gray-50 dark:bg-[#111] border-b border-gray-200 dark:border-darkBorder text-gray-500 dark:text-gray-400 text-xs uppercase tracking-widest"><th className="p-4">Percentage</th><th className="p-4">Grade</th><th className="p-4">Description</th><th className="p-4">School</th><th className="p-4">Action</th></tr></thead>
                <tbody className="text-gray-800 dark:text-gray-200 text-sm">
                  {gradesList.map((g, i) => (
                    <tr key={i} className="border-b border-gray-100 dark:border-darkBorder hover:bg-gray-50 dark:hover:bg-[#1a1a1a]">
